...
///
/// ⚠️ 광고 단위 ID는 현재 Google **공식 테스트 ID**. 출시 전 실제 AdMob 단위
/// ID로 교체해야 한다(실 광고 안 나옴 + 테스트 트래픽으로 계정 정지 방지).
...
class _BannerAdWidgetState extends State<BannerAdWidget> {
  ...
  // TODO(출시): 실제 AdMob 배너 광고 단위 ID로 교체. 현재 adaptive 테스트 ID.
  static String get _adUnitId => Platform.isAndroid
      ? 'ca-app-pub-3940256099942544/9214589741' // Android adaptive 테스트
      : 'ca-app-pub-3940256099942544/2435281174'; // iOS adaptive 테스트
