...
## 작업 시작 전
- 설계/결정 기록/진행 상황: **PLAN.md** 필수 확인
  - v3 작업: `핵심 기술 설계 (v3)`, `PoC 플랜`, `7. v3 설계 결정 기록`
  - v2 수정: `핵심 기술 설계 (v2)`, `3-10. 설계 결정 기록`
...
```
실기기(S22)가 호스트, 에뮬레이터가 게스트, `10.0.2.2`로 접속. 상세: EMULATOR_NETWORK.md
